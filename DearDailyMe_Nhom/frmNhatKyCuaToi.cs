...
namespace DearDailyMe_Nhom
{
    public partial class frmNhatKyCuaToi : Form
    {
        ...
        private void HienThiDanhSach()
        {
            ...
            dgvDanhSachNhatKy.Columns["CamXuc"].DataPropertyName = "CamXuc";
            ...
            foreach (var item in DataStorage.dsnhatky)
            {
                ...
                {
                    dgvDanhSachNhatKy.Rows[rowIndex].Cells["AnhKhoanhKhac"].Value = System.Drawing.Image.FromFile(item.DuongDanAnh);
                }
            }
        }
        ...
        dgvDanhSachNhatKy.RowHeadersWidth, e.RowBounds.Height);
            e.Graphics.DrawString(stt, this.Font, System.Drawing.SystemBrushes.ControlText,
